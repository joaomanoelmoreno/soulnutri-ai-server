...
{"benef":[{"texto":"frase curta até 20 palavras","fonte":"Nome Instituição"}],"riscos":[{"texto":"frase curta até 20 palavras","fonte":"Nome Instituição"}],"curios":"1 frase curta e surpreendente","combo":["combinação 1","combinação 2"],"noticias":[{"texto":"resumo curto","fonte":"Nome Instituição"}],"mito":{"mito":"afirmação popular","resposta":"VERDADE/MITO. Explicação curta","fonte":"Nome Instituição"}}
Regras: benef=3 benefícios nutricionais CURTOS com dado concreto e fonte. riscos=2 riscos CURTOS e específicos com fonte. curios=1 curiosidade surpreendente CURTA. combo=2 combinações alimentares. noticias=1 informação nutricional relevante com fonte. NÃO invente URLs, use apenas nome da instituição (Harvard, OMS, ANVISA, USP, Mayo Clinic, Embrapa, etc - brasileira ou internacional). mito=1 verdade ou mito popular sobre algum ingrediente do prato."""
...
Identifique este prato. O que você vê na imagem? Seja preciso."""
        ...
        if nao_identificado:
            ...
            if _diag_on:
                logger.info(f"[IDENTIFY_GEMINI] request_id={request_id} etapa=nao_identificado_pelo_modelo score={gemini_score}")
