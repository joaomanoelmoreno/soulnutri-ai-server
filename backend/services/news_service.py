...
{{
  "items": [
    {{
      ...
      "fonte_url_referencia": "URL REAL e acessivel do artigo/estudo original. Se nao tem URL exata, use a URL principal do orgao (ex: https://www.who.int). NUNCA invente URLs.",
      "fonte_descricao": "Descricao curta da publicacao original (ex: 'Estudo publicado no The Lancet, vol 403, 2024')",
      "verificado": true,
    ...
    try:
        ...
        for item in items:
            ...
            news_doc = {
                ...
                "fonte_descricao": item.get("fonte_descricao", ""),
