...
UI_TRANSLATIONS = {
    "pt": {
        ...
        # Tutorial do Scanner
        "how_scanner_works": "Como funciona o Scanner",
        "tutorial_step1_title": "Scanner Automático",
        "tutorial_step1_desc": "O SoulNutri detecta automaticamente quando você aponta para um prato diferente e mostra as informações em tempo real.",
        "tutorial_step2_title": "Toque para Detalhes",
        "tutorial_step2_desc": "Quando o scanner identificar um prato, toque na informação que aparece para ver todos os detalhes nutricionais.",
        "tutorial_step3_title": "Monte seu Prato",
        "tutorial_step3_desc": "No buffet, escaneie cada item separadamente. O app soma as calorias automaticamente para você!",
        "skip": "Pular",
        "back": "Voltar",
        "next": "Próximo",
    ...
    "en": {
        ...
        "tutorial_step1_desc": "SoulNutri automatically detects when you point at a different dish and shows the information in real-time.",
        "tutorial_step2_title": "Tap for Details",
        "tutorial_step2_desc": "When the scanner identifies a dish, tap on the information that appears to see all nutritional details.",
        "tutorial_step3_title": "Build Your Plate",
        "tutorial_step3_desc": "At the buffet, scan each item separately. The app adds up the calories automatically for you!",
        "skip": "Skip",
        "back": "Back",
        "next": "Next",
    ...
    "es": {
        ...
        "tutorial_step1_title": "Scanner Automático",
        "tutorial_step1_desc": "SoulNutri detecta automáticamente cuando apuntas a un plato diferente y muestra la información en tiempo real.",
        "tutorial_step2_title": "Toca para Detalles",
        "tutorial_step2_desc": "Cuando el scanner identifique un plato, toca la información que aparece para ver todos los detalles nutricionales.",
        "tutorial_step3_title": "Arma tu Plato",
        "tutorial_step3_desc": "En el buffet, escanea cada elemento por separado. ¡La app suma las calorías automáticamente!",
        "skip": "Saltar",
        "back": "Atrás",
        "next": "Siguiente",
    ...
    "de": {
        ...
        "tutorial_step1_desc": "SoulNutri erkennt automatisch, wenn Sie auf ein anderes Gericht zeigen und zeigt die Informationen in Echtzeit an.",
        "tutorial_step2_title": "Tippen für Details",
        "tutorial_step2_desc": "Wenn der Scanner ein Gericht erkennt, tippen Sie auf die angezeigte Information, um alle Nährwertdetails zu sehen.",
        "tutorial_step3_title": "Stellen Sie Ihren Teller zusammen",
        "tutorial_step3_desc": "Am Buffet scannen Sie jeden Artikel einzeln. Die App addiert die Kalorien automatisch!",
        "skip": "Überspringen",
        "back": "Zurück",
        "next": "Weiter",
        "start_using": "Starten",
