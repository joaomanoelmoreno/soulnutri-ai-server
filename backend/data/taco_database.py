...
INGREDIENTE_PARA_TACO = {
    ...
    "cupim": "carne_bovina_cupim_assado", "filé mignon": "carne_bovina_file_mignon_sem_gordura_grelhado",
    
    # Carnes suínas
    "porco": "carne_suina_lombo_assado", "lombo": "carne_suina_lombo_assado",
    "bacon": "toucinho_defumado", "linguiça": "linguica_de_porco_frita",
    "presunto": "presunto_sem_capa_de_gordura", "salsicha": "salsicha_de_frango",
    "pernil": "carne_suina_pernil_assado",
    ...
    "asa de frango": "frango_asa_inteira_crua", "sobrecoxa": "frango_sobrecoxa_sem_pele_cozida",
    "peru": "peru_peito_sem_pele_assado", "pato": "pato_carne_crua",
    "frango frito": "frango_inteiro_sem_pele_cru",
    
    # Peixes
    "salmão": "salmao_grelhado", "salmon": "salmao_grelhado", "salmao": "salmao_grelhado",
    "bacalhau": "bacalhau_salgado_cru", "tilápia": "tilapia_congelada_crua", "tilapia": "tilapia_congelada_crua",
    "atum": "atum_fresco_cru", "sardinha": "sardinha_inteira_crua", "merluza": "merluza_file_assado",
    "pescada": "pescada_file_frito", "peixe": "peixe_galo_file_cru",
    
    # Frutos do mar
    "camarão": "camarao_cru", "camarao": "camarao_cru", "lula": "lula_crua",
    "polvo": "polvo_cru", "marisco": "ostra_crua", "lagosta": "lagosta_crua",
    "ostra": "ostra_crua",
    
    # Ovos e laticínios
    "ovo": "ovo_de_galinha_inteiro_cozido", "ovos": "ovo_de_galinha_inteiro_cozido",
    "ovo frito": "ovo_de_galinha_inteiro_frito", "clara": "ovo_de_galinha_clara_cozida",
    "queijo": "queijo_minas_frescal", "queijo minas": "queijo_minas_frescal",
    "queijo prato": "queijo_prato", "mussarela": "queijo_mussarela",
    "ricota": "queijo_ricota", "requeijão": "queijo_requeijao_cremoso",
    ...
    "limão": "limao_cru", "melao": "melao_cru",
    
    # Massas e pães
    "macarrão": "macarrao_trigo_cozido", "macarrao": "macarrao_trigo_cozido",
    "massa": "macarrao_trigo_cozido", "lasanha": "lasanha_a_bolonhesa",
    "pão": "pao_frances", "pão francês": "pao_frances", "pao": "pao_frances",
    "pão integral": "pao_de_forma_integral",
    "pizza": "pizza_de_mussarela", "nhoque": "nhoque_a_bolonhesa",
    
    # Preparações típicas
    "feijoada": "feijoada", "estrogonofe": "estrogonofe_de_frango",
    "strogonoff": "estrogonofe_de_frango", "moqueca": "moqueca_de_peixe",
    "farofa": "farofa_de_farinha_de_mandioca", "baião de dois": "baiao_de_dois",
    "coxinha": "coxinha_de_frango_frita", "esfiha": "esfirra_de_carne_assada",
    "salpicão": "salpicao_de_frango", "maionese": "maionese_industrializada",
    
    # Sobremesas
    "pudim": "pudim_de_leite_condensado", "bolo": "bolo_de_chocolate",
    "sorvete": "sorvete_de_creme", "brigadeiro": "brigadeiro",
    "gelatina": "gelatina_sabor_morango",
    
    # Bebidas
    "suco": "suco_de_laranja_industrializado", "café": "cafe_infusao_10_",
    "refrigerante": "refrigerante_tipo_cola", "cha": "cha_mate_infusao_5_",
    "cerveja": "cerveja",
    
    # Oleaginosas
    "castanha": "castanha_do_para_crua", "castanha-do-pará": "castanha_do_para_crua",
    "amendoim": "amendoim_torrado_salgado", "nozes": "noz_crua",
    "amêndoas": "amendoa_torrada_salgada",
}
