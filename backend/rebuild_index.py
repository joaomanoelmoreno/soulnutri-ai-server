...
def main():
    ...
    try:
        ...
        # Backup salvo em /tmp para não consumir espaço em /app
        logger.info("Salvando backup do índice em /tmp...")
        ...
        if os.path.exists(index_file):
            shutil.copy(index_file, "/tmp/dish_index_backup.json")
            logger.info("Backup do índice: /tmp/dish_index_backup.json")
        
        if os.path.exists(embeddings_file):
            shutil.copy(embeddings_file, "/tmp/dish_index_embeddings_backup.npy")
            logger.info("Backup dos embeddings: /tmp/dish_index_embeddings_backup.npy")
